...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:01.209716Z', start_time: '2025-11-13T09:25:00.795758Z'}
import pandas as pd
import numpy as np
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:01.221556Z', start_time: '2025-11-13T09:25:01.217497Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:01.246354Z', start_time: '2025-11-13T09:25:01.228145Z'}
# Test the function
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.119838Z', start_time: '2025-11-13T09:25:01.296342Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.492190Z', start_time: '2025-11-13T09:25:13.487816Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.668458Z', start_time: '2025-11-13T09:25:13.662531Z'}
import logging
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.732439Z', start_time: '2025-11-13T09:25:13.727141Z'}
class DataValidator:
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.796811Z', start_time: '2025-11-13T09:25:13.788533Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.840367Z', start_time: '2025-11-13T09:25:13.831949Z'}
@dataclass
class CleaningStep:
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.891044Z', start_time: '2025-11-13T09:25:13.885513Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.958158Z', start_time: '2025-11-13T09:25:13.948755Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:13.991867Z', start_time: '2025-11-13T09:25:13.980134Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:14.046271Z', start_time: '2025-11-13T09:25:14.027870Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:14.111087Z', start_time: '2025-11-13T09:25:14.057420Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:14.129727Z', start_time: '2025-11-13T09:25:14.116676Z'}
# Summary anzeigen
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:39.454561Z', start_time: '2025-11-13T09:25:14.160006Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:40.134524Z', start_time: '2025-11-13T09:25:40.024284Z'}
def clean_apple_typing(df):
    ...
    # 2️⃣ Datumsfeld (vereinheitlicht auf Garmin-Format "YYYY-MM-DD HH:MM:SS")
    df["date"] = pd.to_datetime(df.get("date"), errors="coerce")

    # vorhandene tz-Infos entfernen, ohne Umrechnung
    mask = df["date"].notna() & df["date"].apply(lambda x: getattr(x, "tzinfo", None) is not None)
    if mask.any():
        df.loc[mask, "date"] = df.loc[mask, "date"].dt.tz_localize(None)

    # sicherstellen, dass es wirklich datetime64[ns] ist
    df["date"] = pd.to_datetime(df["date"], errors="coerce")

    # Format angleichen an Garmin
    df["date"] = df["date"].dt.strftime("%Y-%m-%d %H:%M:%S")

    # export_date kann bleiben wie er ist
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:40.752516Z', start_time: '2025-11-13T09:25:40.598626Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:40.938051Z', start_time: '2025-11-13T09:25:40.885941Z'}
# Summary anzeigen
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:41.183643Z', start_time: '2025-11-13T09:25:41.161146Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:25:41.906969Z', start_time: '2025-11-13T09:25:41.871915Z'}
combined_no_dedupe = (pd.concat([garmin_clean, apple_clean], ignore_index=True)
                      .sort_values("date", kind="stable"))

print(len(combined_no_dedupe))
print(combined_no_dedupe)# sollte Garmin + Apple ergeben
```
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:26:11.715038Z', start_time: '2025-11-13T09:26:11.671040Z'}
# --------------------------------------------------------------
# 5. OUTPUT: Persistierte Version des kombinierten DataFrames
# --------------------------------------------------------------
...
output_dir.mkdir(parents=True, exist_ok=True) # macht (ev. inkl. Elternordnern) Output-Ordner ohne Fehlermeldung
...
parquet_path = output_dir / "combined_runs.parquet"
csv_path     = output_dir / "combined_runs.csv"

# 1) Parquet speichern (beste Wahl für Analyse und Dashboard)
combined_no_dedupe.to_parquet(parquet_path, index=False, engine="pyarrow")

# OPTIONAL: 2) CSV speichern (für Kontrolle oder externes Teilen)
combined_no_dedupe.to_csv(csv_path, index=False)
...
```{python}
#| ExecuteTime: {end_time: '2025-11-13T09:27:51.174921Z', start_time: '2025-11-13T09:27:51.123822Z'}
# Datei laden
