...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:01.841948Z', start_time: '2025-11-12T19:08:01.409298Z'}
import pandas as pd
import numpy as np
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:01.857754Z', start_time: '2025-11-12T19:08:01.851902Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:01.887374Z', start_time: '2025-11-12T19:08:01.862303Z'}
# Test the function
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:15.944692Z', start_time: '2025-11-12T19:08:01.941546Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.086863Z', start_time: '2025-11-12T19:08:16.076186Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.224330Z', start_time: '2025-11-12T19:08:16.218647Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.359392Z', start_time: '2025-11-12T19:08:16.351279Z'}
import logging
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.437011Z', start_time: '2025-11-12T19:08:16.430296Z'}
class DataValidator:
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.520802Z', start_time: '2025-11-12T19:08:16.511617Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.575239Z', start_time: '2025-11-12T19:08:16.564771Z'}
@dataclass
class CleaningStep:
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.644848Z', start_time: '2025-11-12T19:08:16.634182Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.750216Z', start_time: '2025-11-12T19:08:16.726626Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.810931Z', start_time: '2025-11-12T19:08:16.790853Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.875278Z', start_time: '2025-11-12T19:08:16.836943Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:16.972776Z', start_time: '2025-11-12T19:08:16.899849Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:17.005057Z', start_time: '2025-11-12T19:08:16.985762Z'}
# Summary anzeigen
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:31.405112Z', start_time: '2025-11-12T19:08:17.057721Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:31.585953Z', start_time: '2025-11-12T19:08:31.547977Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:31.709152Z', start_time: '2025-11-12T19:08:31.651063Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:31.742357Z', start_time: '2025-11-12T19:08:31.725220Z'}
# Summary anzeigen
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:31.813615Z', start_time: '2025-11-12T19:08:31.799351Z'}
...
```{python}
#| ExecuteTime: {end_time: '2025-11-12T19:08:32.032218Z', start_time: '2025-11-12T19:08:32.018040Z'}
